function velocity = moveWithKeyboard_fast(vr)
...
velocity = [keyboardControl.forward*[sin(-vr.position(4)) 5*cos(-vr.position(4))]+keyboardControl.sideways*[cos(vr.position(4)) sin(vr.position(4))] ...
