function code = linearTrack2Cond_imaging
...
vr.blackRightTower = [beginBlack black backBlack blackRightTower whiteLeftTower];

vr.whiteLeftTower = [beginWhite white backWhite whiteLeftTower blackRightTower];
