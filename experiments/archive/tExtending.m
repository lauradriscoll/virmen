...
vr.debugTic = tic;
if vr.inITI == 0 && abs(vr.position(1)) > eval(vr.exper.variables.armLength)/2 && vr.position(2) > ...
        (eval(vr.exper.variables.wallLength) + eval(vr.exper.variables.delayLength))
